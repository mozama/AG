    ...
    <div class="col-md-10">  <!-- contenido -->
      <article >
        ...
        <!--carrito ultraligero-->
         <form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
			...
			<input type="hidden" name="hosted_button_id" value="4HRA5VTGLKUYG">
        ...
        <!--fin del carrito-->
          ...
          <div class="col-md-4 text-center">
            <h3 class="text-primary">Un pasajero.</h3>
          </div>
        </div>
      ...
      <article >
        ...
        <div class="row">
          <div class="col-md-7 text-center">
              ...
              <form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
				<input type="hidden" name="cmd" value="_s-xclick">
				<input type="hidden" name="hosted_button_id" value="TWB6MVL6ZQJEJ">
				<table>
				<tr><td><input type="hidden" name="on0" value="Visita guiada Zona Arqueológica">Visita guiada Zona Arqueológica</td></tr><tr><td><select name="os0">
				  <option value="Idioma Español">Idioma Español $750.00 MXN</option>
				  <option value="Idioma Ingles">Idioma Inglés $850.00 MXN</option>
				</select> </td></tr>
				</table>
              ...
              <!--fin del carrito-->
            <h4 class="text-warning">* No incluye boleto de entrada, costo por persona: MXN $64</h4>
          </div>
          <div class="col-md-4 text-center">
            <h3 class="text-primary"> De 1 a 20 personas.</h3>
          </div>
        </div>
      </article>
      <br>
      ...
      <article >
        ...
        <div class="row">
          ...
          <form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
<input type="hidden" name="cmd" value="_s-xclick">
<input type="hidden" name="hosted_button_id" value="HGC48L9AC7M2S">
<input type="image" src="https://www.paypalobjects.com/es_XC/i/btn/btn_cart_LG.gif" border="0" name="submit" alt="PayPal, la forma más segura y rápida de pagar en línea.">
<img alt="" border="0" src="https://www.paypalobjects.com/es_XC/i/scr/pixel.gif" width="1" height="1">
</form>
      ...
      <article >
        ...
        <div class="row">
          ...
          <form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
			<input type="hidden" name="cmd" value="_s-xclick">
			<input type="hidden" name="hosted_button_id" value="MFUMTLS4T7BAU">
			<input type="image" src="https://www.paypalobjects.com/es_XC/i/btn/btn_cart_LG.gif" border="0" name="submit" alt="PayPal, la forma más segura y rápida de pagar en línea.">
			<img alt="" border="0" src="https://www.paypalobjects.com/es_XC/i/scr/pixel.gif" width="1" height="1">
		  </form>
          <!-- fin del carrito-->
      ...
      <article >
        ...
        <div class="row">
          ...
          <div class="col-md-4 text-center">
            <h3 class="text-primary">A partir de 1 persona.</h3>
          </div>
        </div>
