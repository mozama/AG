  ...
  <div class="row">
    ...
    <div class="col-md-10">  <!-- contenido -->
      <article >
        <div class="row cabeceraAventura">
          <div class="col-lg-12">
            ...
            <h3 class="junction"><i class="fa fa-bookmark"></i> Paquete vuela y temazcal:</h3>
          </div>
        </div>
        <div class="row">
          <div class="col-md-7">
            ...
            <ul>
              ...
              <li class="juntion">Tansportación local durante la actividad.</li>
              <li class="juntion">Seguro de pasajeros.</li>
              <li class="junction">Explicación sobre Temazca.</li>
      ...
      <article >
        <div class="row cabeceraVuelo">
          <div class="col-lg-12">
            <h3 class="junction"><i class="fa fa-bookmark"></i> Paquete vuela y rueda: <small class="textoBlanco">Vuelo en gobo + Tour en bici</small></p>
          </div>
        </div>
        <div class="row">
          <div class="col-md-7">
      ...
      <article >
        <div class="row cabeceraVuelo">
          <div class="col-lg-12">
            <h3 class="junction"><i class="fa fa-bookmark"></i> Paquete vuelo + aventura: <small class="textoBlanco">Vuelo en gobo + Cuatrimoto</small></p>
          </div>
        </div>
        <div class="row">
          <div class="col-md-7">
