        ...
        <div class="row">
          <div class="col-md-8">
            ...
            <ul>
              ...
              <li class="junction">Habitación ocupación <span class="text-primary"> doble</span> <span class="text-warning">MX $1,100</span> pesos por noche.</li>
              <li class="junction">Habitación ocupación <span class="text-primary"> triple</span> <span class="text-warning">MX $1,350</span> pesos por noche.</li>
              <li class="junction">Habitación ocupación <span class="text-primary"> cuádruple</span> <span class="text-warning">MX $1,450</span> pesos por noche.</li>
            </ul>
            <br>
          <!-- carrito quinto sol-->
               ...
               <table>
               <tr><td><input type="hidden" name="on0" value="Hotel Quinto Sol Habitacion"></td></tr><tr><td><select name="os0">
            ...
            <article >
              ...
              <div class="row">
                <div class="col-md-8">
                  ...
                  <ul>
                    <li class="junction">Costo por noche de hospedaje.</li>
                    <li class="junction">Habitación ocupación <span class="text-primary"> doble</span> <span class="text-warning">MX $850</span> pesos por noche.</li>
                    <li class="junction">Jacuzzi.</li>
                  </ul>
              ...
              <div class="row">
                <div class="col-md-8">
                  ...
                  <ul>
                    ...
                    <li class="junction">Habitación ocupación <span class="text-primary"> triple</span> <span class="text-warning">MX $650</span> pesos por noche.</li>
                    <li class="junction">Habitación ocupación <span class="text-primary"> cuádruple</span> <span class="text-warning">MX $700</span> pesos por noche.</li>
                  </ul>
                  <!-- carrito posada jade-->
                          <form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
                          <input type="hidden" name="cmd" value="_s-xclick">
