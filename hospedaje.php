        ...
        <div class="row">
          ...
          <!-- carrito quinto sol-->
               ...
               <tr><td><input type="hidden" name="on0" value="Hotel Quinto Sol Habitacion">Hotel Quinto Sol Habitacion</td></tr><tr><td><select name="os0">
                 ...
                 <option value="Habitacion ocupacion cuadruple">Habitacion ocupacion cuadruple $1,450.00 MXN</option>
               </select> </td></tr>
               </table>
          ...
          <div class="col-md-8">
            ...
            <!-- carrito posada jade-->
                    ...
                    <tr><td><input type="hidden" name="on0" value="Posada Jade Hataciones">Posada Jade Hataciones</td></tr><tr><td><select name="os0">
                      ...
                      <option value="Habitacion ocupacion tiple">Habitacion ocupacion tiple $650.00 MXN</option>
